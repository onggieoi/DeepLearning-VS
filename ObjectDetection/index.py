...
# Images
images_dir = 'datasets/self_driving_datasets/'

# Ground truth
train_labels_filename = 'datasets/self_driving_datasets/labels_train.csv'
val_labels_filename = 'datasets/self_driving_datasets/labels_val.csv'
